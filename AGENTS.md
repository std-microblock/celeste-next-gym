...
- Treat the annotated upstream Celeste player implementation as the primary source of truth for player states, constants, coroutine timing, collision order, and comments: `docs/Player.cs`
