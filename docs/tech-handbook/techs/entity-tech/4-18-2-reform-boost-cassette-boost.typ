...
#tech(
  ...
  description-en: [CassetteBlock checks BlockedCheck, may wiggle an overlapping actor up by at most four pixels, then enables collision and shifts its Solid upward by one pixel. Rust reproduces the beat/index lifecycle and the real Everest scenario matches all nine core fields.],
