...
#tech(
  ...
  e2e-evidence: none,
  candidate-e2e: evidence(path: [scripts/e2e-real/scenarios/playground/entity-4.26-theovator.ts / scripts/e2e-real/scenarios/playground/entity-4.26-jellyvator.ts], symbol: [entity-4.26-theovator / entity-4.26-jellyvator], note: [2026-07-28 真实 Everest 重跑中，Theovator 61 帧的位置、速度、状态、朝向、冲刺数、体力、落地、蹲伏和死亡九字段均匹配（最大位置／速度误差 0／0）。但 Jellyvator 第 47 帧游戏为 (60, 492)、(0, -240)、Dash，Rust 为 (60, 496)、零速、Pickup；最大位置／速度误差 46／240。因此合并的 4.26 技巧仍保持 candidate。]),
)
