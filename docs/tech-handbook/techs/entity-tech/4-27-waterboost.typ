...
#tech(
  ...
  e2e-evidence: none,
  candidate-e2e: evidence(path: [scripts/e2e-real/scenarios/playground/entity-4.27-waterboost.ts], symbol: [entity-4.27-waterboost], note: [独立水池 MapPart 连续三帧跳跃，候选语义速度依次约为 50、100、135.66666，第三次 Y 为 -105；尚待真实 Everest 九字段逐帧比较。]),
)
