...
#tech(
  ...
  e2e-evidence: none,
  candidate-e2e: evidence(path: [scripts/e2e-real/scenarios/playground/entity-4.18.2.1-cassoosted-fuper.ts; scripts/e2e-real/scenarios/cassette-spinner-parts.ts; mods/CelesteGymCollector/Source/SnapshotCapture.cs], symbol: [entity-4.18.2.1-cassoosted-fuper; TECH_ENTITY_4_18_2_1_CASSOOSTED_FUPER; SnapshotCapture.Capture], note: [2026-07-28 隔离真实 Everest run `2026-07-28T13-41-44.489Z-90784-8038eac1-ccd2-4e7b-99a6-226711fa7273` 完成 nonce/PID 认证及受控清理；旧场景在首个可控 StarFly 帧之后才按跳跃，速度已衰减，semantic gate fuper=-1。候选现改为 tempo=3，使 beat-8 reform 与 Feather Coroutine 后的首个 `Player.Jump` 同帧；尚未重跑真实 Everest，故不转正。]),
)
