...
#tech(
  ...
  e2e-evidence: none,
  candidate-e2e: evidence(path: [scripts/e2e-real/scenarios/playground/entity-4.19-seeker-bounce.ts], symbol: [entity-4.19-seeker-bounce], note: [2026-07-28 隔离真实 Everest run `2026-07-28T13-13-33.419Z-71608-4a736796-081e-4303-a6c3-b0ab27f9aa42` 完成 nonce/PID 认证与受控清理。候选形成 PointBounce 语义，但第 36 帧先差：Rust 位置 (214,481)、速度 (90,135)，Everest 位置 (214,483)、速度 (90,-140)；最大位置／速度误差 74／300。随后 run `2026-07-28T13-32-48.426Z-101912-0050dd19-43bb-4438-8fd0-f51bdec47ad1` 验证把普通 bounce hitbox 扩至 16px 会第 19 帧过早触发 Rust Bounce（位置 (189,481)、速度 (90,-140)；Everest (189,477)、(90,-105)），因此已撤销该猜测；保持未实现。]),
)
