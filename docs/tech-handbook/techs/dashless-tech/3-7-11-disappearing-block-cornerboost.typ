...
#tech(
  ...
  e2e-evidence: none,
  candidate-e2e: evidence(path: [scripts/e2e-real/scenarios/playground/dashless-3.7.11-disappearing-block-cornerboost.ts; scripts/e2e-real/scenarios/cassette-spinner-parts.ts; mods/CelesteGymCollector/Source/SnapshotCapture.cs], symbol: [dashless-3.7.11-disappearing-block-cornerboost; TECH_DASHLESS_3_7_11_DISAPPEARING_BLOCK_CORNERBOOST; SnapshotCapture.Capture], note: [2026-07-28 隔离真实 Everest run `2026-07-28T13-41-05.671Z-101904-26cdd64f-2ccf-431d-85a0-e61c54b4e234` 完成 nonce/PID 认证及受控清理；旧场景的标准 tempo 使碰墙早于失活超过 retained-speed 窗口，首差为 frame 82：Rust=(124,496)/(16.667,0)，Everest=(126,496)/(90,0)。候选现采用 tempo=3，将撞墙固定在 beat-8 activation、清碰撞与返还之前；尚未重跑真实 Everest，故不转正。]),
)
