...
#tech(
  ...
  source-evidence: evidence(path: [Source/Player/Player.cs], symbol: [Player.OnCollideV; Player.DashUpdate; Player.SuperJump], note: [空中下斜冲刺落地时转成 1.2 倍水平蹲伏滑行，再由 DashUpdate 跳成 Hyper。]),
