...
#tech(
  ...
  source-evidence: evidence(
    path: [Everest Celeste.Mod.mm/Patches/Player.cs; Source/Player/Player.cs],
    symbol: [CrouchDash patch; Player.SuperJump],
    ...
    note: [Everest crouch dash 保持蹲伏碰撞箱，随后复用原版 SuperJump 的 1.25/0.5 蹲伏倍率。],
  ),
