...
#tech(
  ...
  e2e-evidence: evidence(path: [scripts/e2e-real-collector.mjs], symbol: [dash-grounded-ultra; verifyGroundedUltra], note: [真实 13 帧场景以 300 水平入速贴地向下斜冲，确认落地时保持 ducking 并取得至少 360 的 1.2 倍速度；九类核心字段最大位置与速度误差均为 0。]),
  candidate-e2e: none,
)
