...
#tech(
  ...
  e2e-evidence: evidence(path: [scripts/e2e-real-collector.mjs], symbol: [dash-superwave; verifySuperwave], note: [真实 31 帧场景确认第 11 帧 extended Super 为 260/-105 且冲刺回填，第 22 帧反向下斜落地，第 27 帧反向 Hyper 为 -325/-52.5；九类核心字段最大位置误差 0、速度误差 0.000004。]),
  candidate-e2e: none,
)
