...
#tech(
  ...
  e2e-evidence: none,
  candidate-e2e: evidence(path: [scripts/e2e-real/scenarios/playground/other-5.1.3-bino-interaction-storage.ts; scripts/e2e-real/scenarios/lookout-parts.ts; scripts/e2e-real/test/playground-map.test.ts], symbol: [other-5.1.3-bino-interaction-storage; TECH_OTHER_5_1_3_BINO_INTERACTION_STORAGE; keeps Bino candidates in valid source-timed fixture and input windows], note: [有效且完全包含的 `[956,493,4,4]` fixture 保留 x=958 Lookout center 与 Player 触边条件。2026-07-28 认证的独立 Everest run `2026-07-28T13-02-13.337Z-75256-574b44be-c90b-4ccf-9d21-df990e150b29`（nonce/PID 匹配、受控清理）通过 fixture 加载，却没有观察到 `Lookout.Removed`；保持 candidate，待修正实际 room transition 时序。]),
)
