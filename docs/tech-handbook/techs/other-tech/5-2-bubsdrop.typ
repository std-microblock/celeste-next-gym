...
#tech(
  ...
  e2e-evidence: none,
  candidate-e2e: evidence(path: [scripts/e2e-real/scenarios/playground/other-5.2-bubsdrop.ts; scripts/e2e-real/scenarios/bubs-parts.ts; mods/CelesteGymCollector/Source/SnapshotCapture.cs], symbol: [other-5.2-bubsdrop; TECH_OTHER_5_2_BUBSDROP; sessionRespawnPoint], note: [独立双房 MapPart 现在在上房放置相邻 wall 与 JumpThru，脚本验证 -105 auto-jump、`(-130,-105)` 墙跳及 y>0 回旧房；collector 输出 Session.Level 和 RespawnPoint。仍须在主工作区运行真实 Everest，并在含两个旧房 spawn 的 fixture 中比较回房后的 RespawnPoint，故保持 candidate。]),
)
