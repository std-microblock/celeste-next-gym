...
#tech(
  ...
  e2e-evidence: none,
  candidate-e2e: evidence(path: [scripts/e2e-real/scenarios/playground/other-5.8-roboboost.ts; scripts/e2e-real/scenarios/common-parts.ts], symbol: [other-5.8-roboboost; TECH_OTHER_5_8_ROBOBOOST], note: [独立 MapPart 使用真实 vanilla MoveBlock 与 8px 宽短角墙。第 22 个输入帧在上升期执行 ClimbJump，使 OnCollideH 保存大于 300 的速度；越过 6px 墙顶仍在 0.06 秒保留窗口内恢复大于 300，随后反向输入。候选仍待真实 Everest 九字段对照。]),
)
