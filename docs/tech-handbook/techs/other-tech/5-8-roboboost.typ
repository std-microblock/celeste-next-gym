...
#tech(
  ...
  e2e-evidence: none,
  candidate-e2e: evidence(path: [scripts/e2e-real/scenarios/playground/other-5.8-roboboost.ts; scripts/e2e-real/scenarios/common-parts.ts], symbol: [other-5.8-roboboost; TECH_OTHER_5_8_ROBOBOOST], note: [独立 MapPart 使用真实 vanilla MoveBlock 与 8px 角墙。最终真实 Everest 语义门观测到 Hyper=21、retained=28，但 restored=-1，未形成 >100 的反向 Cornerboost 恢复速度，故保持 candidate。]),
)
