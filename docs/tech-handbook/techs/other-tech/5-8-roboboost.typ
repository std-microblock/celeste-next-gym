...
#tech(
  ...
  e2e-evidence: none,
  candidate-e2e: evidence(path: [scripts/e2e-real/scenarios/playground/other-5.8-roboboost.ts; scripts/e2e-real/scenarios/common-parts.ts], symbol: [other-5.8-roboboost; TECH_OTHER_5_8_ROBOBOOST], note: [独立 MapPart 使用真实 vanilla MoveBlock 与 8px 角墙，候选要求同一轨迹出现 >300 Hyper、wallSpeedRetentionTimer 和 >100 恢复速度；未通过前不转正。]),
)
