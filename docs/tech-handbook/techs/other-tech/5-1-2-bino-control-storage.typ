...
#tech(
  ...
  e2e-evidence: none,
  candidate-e2e: evidence(path: [scripts/e2e-real/scenarios/playground/other-5.1.2-bino-control-storage.ts; mods/CelesteGymCollector/Source/CelesteGymCollectorModule.cs; crates/celeste-physics/src/sim.rs], symbol: [other-5.1.2-bino-control-storage; InstallScriptedButtons; bino_control_storage_keeps_normal_player_and_camera_control_parallel], note: [2026-07-28 认证的独立 Everest run `2026-07-28T13-01-34.662Z-67952-63ebe3b7-ede4-47d9-9fdb-04a029b8cf13`（nonce/PID 匹配、受控清理）已把首差从 frame 16 后移到 frame 18：Rust=(510,496), Dummy, speed.x=33.333；Everest=(511,496), Boost, speed.x=33.333。原生 trace 确认 Booster 为 Circle(10, offset 0,2)，Rust 已使用 Lookout DummyWalk 的前一帧 PlayerCollider；保持 candidate，待修正 Boost 对齐位移。]),
)
