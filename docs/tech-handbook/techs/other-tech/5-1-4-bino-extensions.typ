...
#tech(
  ...
  e2e-evidence: none,
  candidate-e2e: evidence(path: [scripts/e2e-real/scenarios/playground/other-5.1.4-bino-extensions.ts; crates/celeste-physics/src/sim.rs], symbol: [other-5.1.4-bino-extensions; bino_extensions_follow_nodes_and_run_long_distance_exit_wipe], note: [2026-07-28 的独立 Everest trace 在 560 帧前未完成 summit endpoint exit。候选窗口现延长到 720 帧，完整三节点本地回归要求 node 2、超过 600px、phase 6 和最终 Normal；保持 candidate，待真实 Everest 重跑。]),
)
