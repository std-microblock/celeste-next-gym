...
#tech(
  ...
  e2e-evidence: none,
  candidate-e2e: evidence(path: [scripts/e2e-real/scenarios/playground/other-5.1.4-bino-extensions.ts; crates/celeste-physics/src/sim.rs], symbol: [other-5.1.4-bino-extensions; bino_extensions_follow_nodes_and_run_long_distance_exit_wipe], note: [候选窗口为 720 帧，完整三节点本地回归要求 node 2、超过 600px、phase 6 和最终 Normal。2026-07-28 认证的独立 Everest run `2026-07-28T13-02-39.370Z-50832-481014aa-bcf1-4e51-bbec-0e8f2a297130`（nonce/PID 匹配、受控清理）仍未完成 summit endpoint exit；保持 candidate，待修正真实 Lookout 退出时序。]),
)
