...
#tech(
  ...
  e2e-evidence: evidence(path: [scripts/e2e-real/scenarios/playground/other-5.6-kermit-dash.ts], symbol: [other-5.6-kermit-dash; verifyKermitDash], note: [独立双房间 MapPart 记录 48 个真实状态；语义守卫在 Dash→Normal 首帧和资源恢复完成帧读取 Everest DashDir/dashAttackTimer，确认完整切房后方向与攻击窗口仍保留。九类核心字段逐帧一致，最大位置误差 0.000015、速度误差 0。]),
  candidate-e2e: none,
)
