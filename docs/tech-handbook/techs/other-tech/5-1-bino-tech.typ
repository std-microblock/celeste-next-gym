...
#tech(
  ...
  e2e-evidence: none,
  candidate-e2e: evidence(path: [scripts/e2e-real/scenarios/playground/other-5.1-bino-tech.ts; scripts/e2e-real/scenarios/lookout-parts.ts], symbol: [other-5.1-bino-tech; TECH_OTHER_5_1_BINO_TECH], note: [独立 Lookout MapPart 读取真实 interacting、Dummy 和 Level.Camera；真机 semantic gate 通过前保持 candidate。]),
)
