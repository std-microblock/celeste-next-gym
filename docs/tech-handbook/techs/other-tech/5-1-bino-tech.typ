...
#tech(
  ...
  e2e-evidence: none,
  candidate-e2e: evidence(path: [scripts/e2e-real/scenarios/playground/other-5.1-bino-tech.ts; crates/celeste-physics/src/sim.rs], symbol: [other-5.1-bino-tech; advance_lookout_exit; lookout_talk_runs_dummy_wait_hud_camera_and_exit_lifecycle], note: [2026-07-28 的独立 Everest trace 曾在 frame 130 给出 Rust=Dummy、Everest=Normal。现将 HUD Hide 前移到退出输入的同一 LookRoutine resume，并以 frame 130 Normal 的本地回归锁定；仍为 candidate，待在真实 Everest 重跑九字段比较。]),
)
