...
#tech(
  ...
  e2e-evidence: none,
  candidate-e2e: evidence(path: [scripts/e2e-real/scenarios/playground/other-5.1-bino-tech.ts; scripts/e2e-real/scenarios/lookout-parts.ts], symbol: [other-5.1-bino-tech; TECH_OTHER_5_1_BINO_TECH], note: [2026-07-28 独立真实 Everest run `2026-07-28T10-29-54.404Z-87584-93b2f1b1-3abd-4d37-8eeb-64681df8c1f0` 已完成认证与清理，但九字段 frame 130 状态不一致：Rust=Dummy、Everest=Normal（position/speed 均为 0 误差）。保持 candidate，待修正 lifecycle frame ordering 后复测。]),
)
