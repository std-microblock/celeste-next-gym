...
#tech(
  ...
  source-evidence: evidence(path: [Source/Player/Player.cs], symbol: [Player.Update; Player.NormalUpdate], note: [接地时设置 0.1 s jumpGraceTimer，离地后逐帧扣减并在 NormalUpdate 中优先消费。]),
