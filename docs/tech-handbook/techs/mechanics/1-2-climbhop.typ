...
#tech(
  ...
  rust-evidence: evidence(path: [crates/celeste-physics/src/types.rs; crates/celeste-physics/src/sim.rs], symbol: [PlayerSnapshot.hop_wait_x; slip_check; climb_update; climb_hop; update_hop_wait]),
