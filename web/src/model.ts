...
export type EntityKind = 'jump_thru' | 'spikes' | 'water' | 'dream_block' | 'booster' | 'red_booster' | 'fly_feather' | 'bumper' | 'ice_ball' | 'badeline_boost' | 'wind' | 'bounce_block' | 'zip_mover' | 'moving_solid' | 'unknown'
