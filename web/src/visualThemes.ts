...
export const VISUAL_THEMES: readonly VisualTheme[] = [
  ...
  },
  {
    ...
    spinner: {
      foreground: "sj/spinners/beginner/fg",
      background: "sj/spinners/beginner/bg",
    },
    background: "#8dc8ec",
    layers: [
  ...
  },
  {
    ...
    spinner: {
      foreground: "sj/spinners/intermediate/fg",
      background: "sj/spinners/intermediate/bg",
    },
    background: "#25204f",
    layers: [
  ...
  },
  {
    ...
    spinner: {
      foreground: "sj/spinners/advanced/fg",
      background: "sj/spinners/advanced/bg",
    },
    background: "#351b55",
    layers: [
