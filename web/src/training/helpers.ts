...
export const hold = (id: string, keys: string[]) => ({
  id,
  keys,
  at: 0,
  held_time: "hold::inf",
...
export const press = (id: string, keys: string[], at: number | string) => ({
  id,
  keys,
  at,
  verify: true,
...
export function room(
  ...
  return {
    ...
    solids: [
      ...(options.floorSegments ?? [
        { x: 0, y: floorY, width, height: height - floorY },
      ]),
