...
The selected Gameplay entries cover Madeline, terrain, and every entity renderer exposed by the current Web map model, including Puffer, Angry Oshiro, Seeker, Snowball, Cloud, Glider, and MoveBlock. The splash image is currently used as the page backdrop. The two color-grade textures are retained beside it for the planned visual redraw/replacement pass. Celeste and its original assets belong to their respective rights holders; these files are not intended as independently redistributable project assets.
