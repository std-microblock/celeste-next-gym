...
export type FixtureEntity =
  | (FixtureEntityBase & { readonly kind: 'jump_thru' | 'water' | 'dream_block' | 'bumper' | 'puffer' | 'angry_oshiro' | 'seeker' | 'snowball' | 'cloud' | 'bounce_block' | 'theo_crystal' | 'heart_gem' | 'glider' | 'strawberry' | 'booster' | 'red_booster' | 'temple_gate' })
