...
export const scenario = defineScenario({
  ...
  techniqueIds: ["5.2"],
  mapParts,
  name: "other-5.2-bubsdrop",
  room: "playground",
  initial: { pos: [452, 4], speed: [0, -160], dashes: 0, stamina: 20 },
  inputs: Array.from({ length: 140 }, (_, frame) =>
    input({
