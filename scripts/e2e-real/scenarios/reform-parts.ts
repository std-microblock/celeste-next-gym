...
function reformPart(id: string, rooms: MapPart["rooms"]): MapPart {
...
export const TECH_ENTITY_4_17_MOON_BOOST = reformPart(
...
export const TECH_ENTITY_4_18_REFORM_TECH = reformPart(
  ...
  [
    {
      ...
      entities: [
        {
          id: "tech-4.18-move-block",
          kind: "move_block",
          bounds: [320, 400, 32, 16],
          direction: [1, 0],
          name: "moveBlock",
        },
        {
...
export const TECH_ENTITY_4_18_1_REFORM_KICK = reformPart(
  ...
  [
    {
      name: ROOM,
      entities: [
        // The engine tile scan selects x=712 as the first engine-clear
        // eight-pixel-aligned reset target, so all attached source geometry
        // moves by the same delta.
        {
          id: "tech-4.18.3-bounce-block",
          kind: "bounce_block",
          bounds: [712, 480, 64, 16],
          name: "bounceBlock",
        },
        {
          id: "tech-4.18.3-spikes",
          kind: "spikes",
          bounds: [776, 480, 3, 16],
          direction: [1, 0],
          name: "spikesRight",
