...
export const ENTITY_4_23_THEO_ULTRA_PART = defineMapPart({
  id: "tech.entity-4.23-theo-ultra",
  dependencies: [],
  package: PACKAGE,
  sid: SID,
  rooms: [
...
export const ENTITY_4_24_BUMPER_SMUGGLE_PART = defineMapPart({
  id: "tech.entity-4.24-bumper-smuggle",
  dependencies: [],
  package: PACKAGE,
  sid: SID,
  rooms: [
...
export const ENTITY_4_25_THROWABLE_BACKBOOST_PART = defineMapPart({
  id: "tech.entity-4.25-throwable-backboost",
  dependencies: [],
  package: PACKAGE,
  sid: SID,
  rooms: [
...
export const ENTITY_4_27_WATERBOOST_PART = defineMapPart({
  id: "tech.entity-4.27-waterboost",
  dependencies: [],
  package: PACKAGE,
  sid: SID,
  rooms: [
