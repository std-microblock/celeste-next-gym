...
export const TECH_ENTITY_4_10_3_DREAM_SMUGGLE = fixturePart('tech.entity-4.10.3-dream-smuggle', {
  entities: [
    { id: 'tech-4.10.3-dream', kind: 'dream_block', bounds: [231, 432, 104, 64], name: 'dreamBlock' },
...
export const TECH_ENTITY_4_10_3_1_DREAM_GRAB_HYPER = fixturePart('tech.entity-4.10.3.1-dream-grab-hyper', {
  entities: [{ id: 'tech-4.10.3.1-dream', kind: 'dream_block', bounds: [231, 432, 104, 64], name: 'dreamBlock' }],
})
export const TECH_ENTITY_4_10_3_2_HOLDABLE_DREAM_HYPER = fixturePart('tech.entity-4.10.3.2-holdable-dream-hyper', {
  entities: [
    { id: 'tech-4.10.3.2-dream', kind: 'dream_block', bounds: [231, 432, 104, 64], name: 'dreamBlock' },
...
export const TECH_ENTITY_4_10_4_HOLDABLE_GRABLESS_DREAM_HYPER = fixturePart('tech.entity-4.10.4-holdable-grabless-dream-hyper', {
  entities: [
    { id: 'tech-4.10.4-dream', kind: 'dream_block', bounds: [231, 432, 104, 64], name: 'dreamBlock' },
...
export const TECH_OTHER_5_8_ROBOBOOST = fixturePart('tech.other-5.8-roboboost', {
  // This is a short 8px-wide corner, above the MoveBlock's body.  It lets the
  // rising ClimbJump store its pre-collision speed and clear the top inside
  // Player.WallSpeedRetentionTime without redirecting the MoveBlock itself.
  solids: [[448, 458, 8, 6]],
