...
export function createRunContext(options: {
  ...
  const context: RunContext = {
    ...
    manifest: {
      ...
      git: options.git,
      game: { root: options.gameInstall.gameRoot, executable: options.gameInstall.executable },
...
export function updateRunManifest(context: RunContext, patch: Readonly<Record<string, unknown>> = {}): void {
