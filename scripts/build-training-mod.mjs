...
function validateTraining(training, id) {
  if (!training || training.version !== 2 || typeof training.id !== "string" || !training.id.trim() || !Array.isArray(training.modules) || !training.finish?.trigger) {
    throw new Error(`${id}: invalid version 2 training document`);
  }
